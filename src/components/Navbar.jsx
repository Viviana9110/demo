...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: t("navbar.destinos"), path: "/destination" },
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-4">
        ...
        <select
          ...
          className="ml-4 px-2 py-1 rounded-md border border-gray-300 text-sm bg-white shadow-sm cursor-pointer"
        >
      ...
      >
        ...
        <select
          onChange={(e) => i18n.changeLanguage(e.target.value)}
          defaultValue={i18n.language}
          className="mt-4 px-3 py-2 rounded-md border border-gray-300 text-sm bg-white shadow-sm cursor-pointer"
        >
